...
<head>
    <link rel="stylesheet" type="text/css" href="./assets/css/product_details.css?version=56">
        ...
        .then(data => {
            ...
            const App = {
                khoidong() {
                    ...
                    (() => {
                        const product_name = $('.product__name').innerText
                        if (!product_name.includes('iPhone 15')) {
                            $('.product__trademark').style.display = 'none'
                            $('.product__more--box').innerHTML = `<div class="product__complimentary fs-5 text-secondary">
